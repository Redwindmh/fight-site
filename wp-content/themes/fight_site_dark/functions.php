...
function fight_site_styles() {
    ...
    wp_enqueue_style('fight-night-fontawesome', "https://kit.fontawesome.com/5bf705b190.js", array(), 3, 'all');
...
function fight_site_scripts() {
    ...
    wp_enqueue_script('fight-night-js', get_template_directory_uri() . "/js/main.js", array(), 1, true);
